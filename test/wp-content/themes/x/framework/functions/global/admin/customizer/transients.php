...
function x_customizer_set_transients_before_save() {
  set_transient( 'x_transient_portfolio_slug_before', x_get_option( 'x_custom_portfolio_slug', 'portfolio-item' ), 60 );  
}
...
function x_customizer_set_transients_after_save() {
  set_transient( 'x_transient_portfolio_slug_after', x_get_option( 'x_custom_portfolio_slug', 'portfolio-item' ), 60 );  
}
