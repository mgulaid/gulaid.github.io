...
function x_portfolio_item_featured_content() {
  ...
  $cropped_thumbs = x_get_option( 'x_portfolio_enable_cropped_thumbs', 0 );
...
function x_portfolio_item_social() {
  ...
  $enable_google_plus  = x_get_option( 'x_portfolio_enable_google_plus_sharing', '0' );
  $enable_linkedin     = x_get_option( 'x_portfolio_enable_linkedin_sharing', '0' );
  $enable_pinterest    = x_get_option( 'x_portfolio_enable_pinterest_sharing', '0' );
  $enable_reddit       = x_get_option( 'x_portfolio_enable_reddit_sharing', '0' );
  $enable_email        = x_get_option( 'x_portfolio_enable_email_sharing', '0' );
