...
jQuery(document).ready(function($) {
  ...
  $('a[href*="customize.php"]').click(function() {
    ...
    $('body').prepend('<div id="x-customizer-preloader"><div id="x-customizer-preloader-inner"><p class="status"><span class="loading">Loading</span><span class="step">(Step 1 of 2) Initializing X Customizer</span></p></div><h1 class="powered-by">Powered by Theme.co</h1></div>');
  });
